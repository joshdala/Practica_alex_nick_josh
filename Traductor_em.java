...
public class Traductor_em extends JFrame {
	...
	public Traductor_em() {
		...
		lblimagen.setBounds(383, 150, 211, 118);
		contentPane.add(lblimagen);
		
		JButton btnimagen = new JButton("Mostrar Imagen");
		btnimagen.setBounds(463, 114, 121, 25);
		btnimagen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				String palabra = textTraducir.getText().toLowerCase();
				if (palabra.equals("hola")){
					lblimagen.setIcon(new ImageIcon ("src/holaJPEG.jpg"));
				}
				
				else if (palabra.equals("adios")){
						lblimagen.setIcon(new ImageIcon ("src/adiosJPEG.jpg"));
				}
						
				else if (palabra.equals("galleta")){
							lblimagen.setIcon(new ImageIcon ("src/galletaJPEG.jpg"));
				}
